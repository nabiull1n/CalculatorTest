...
class MainStackView: UIStackView {
    ...
    private func createButton(title: String, tag: Int, color: UIColor) -> UIButton {
        ...
        button.addTarget(self, action: #selector(keyboardButtonTaped), for: .touchUpInside)
        return button
    }
    @objc private func keyboardButtonTaped(sender: UIButton) {
    ...
    private func setupMainStackView() {
        ...
        let buttonMulty = createButton(title: "х", tag: 14, color: .orange)
